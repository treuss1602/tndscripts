...
def create_confluence_html_tables(name, action, inputparams, outputparams, prefix_return_params):
    ...
    if action not in ["Display", "Compare"]:
        ...
        print(tablerow("EXTERNAL_ORDER_ID", "General", "Reference to the order number. Generated by the northbound system. Not used.", "O00324572912", "O", alignments=IALIGNS))
...
def create_confluence_markup(heading, name, action, inputparams, outputparams, prefix_return_params=True):
    ...
    if action not in ["Display", "Compare"]:
        ...
        print("|EXTERNAL_ORDER_ID|General|Reference to the order number. Generated by the northbound system. Not used.|O00324572912|O|")
    for param in inputparams:
