...
def create_confluence_table(cfsname, input_parameters, display_parameters, header=True):
...
if __name__ == "__main__":
    ...
    create_confluence_table(cfsname, [(p[0], *paramdetails[p[0]]) for p in inputparams], [(p[0], *paramdetails[p[0]]) for p in displayparams])
