...
def create_confluence_html(cfsname, input_parameters, display_parameters, fpversions):
    ...
    print("</ul>")
    neparam = ('NETWORK_ELEMENT_NAME', 'The network element on which to provsion the CFS.', 'ZH0004MEB101')
    cfsparam = ("CFS_NAME", "Name of the CFS as generated by Cramer", samplename)
    ...
    create_confluence_html_section("Display", cfsname, "Delete", [cfsparam], display_parameters)
