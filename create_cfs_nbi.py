...
BASEPARAMS = {
    ...
    "Provision": (
        [
            ...
            ("PREPARE_MIGRATION", "Order Line", "Whether the Stablenet action \"prepare_migration\" shall be used instead of \"new_rfs\".\nDefault is false", "true", "O"),
            ("MIGRATION_KEY", "Order Line", "Unique key shared by all RFSs a part of the migration PW.\nMandatory if PREPARE_MIGRATION=true", "c54b4ac0-4185-49a2-b6eb-c8133604d102", "C"),
            ("APPLY_CONTEXT", "Order Line", "Whether or not the context shall be applied in Cramer in the Finalize phase.\nDefault is true", "false", "O"),
        ],
        []
    ),
