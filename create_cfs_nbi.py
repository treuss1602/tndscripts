...
def create_confluence_html_section(heading, name, action, inputparams, outputparams):
    ...
    if action == "Create":
        print(tablerow("SKIP_PROVISIONING", "Order Line", "Whether the flow should skip Provision and Finalize phases. This should only be true if there is a master flow that will execute the Provision flow separately.", "false", "M", alignments=IALIGNS))
    elif action == "Delete":
        print(tablerow("SKIP_PROVISIONING", "Order Line", "hether the flow should skip Provision and Finalize phases. This should only be true if there is a master flow that will execute the Deprovision flow separately.", "false", "M", alignments=IALIGNS))
